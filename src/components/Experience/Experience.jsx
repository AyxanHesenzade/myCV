    ...
    return (
        <section id="experience" className="py-24 bg-[#0d1117]">
            <div className="container mx-auto px-6">
                <h2 className="text-4xl font-bold font-display mb-16 text-center">Professional <span className="text-accent">Journey</span></h2>
                        ...
                        >
                            ...
                            <div className={`grid md:grid-cols-2 gap-8 items-start ${index % 2 !== 0 ? 'md:direction-reverse' : ''}`}>
                                ...
                                <div className="glass-morphism p-6 rounded-2xl relative">
                                    ...
                                    <p className="text-gray-400 mb-4 italic text-sm">{exp.description}</p>
